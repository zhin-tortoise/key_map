 ...
 * |------+------+------+------+------+------|  |------+------+------+------+------+------|
 * |LOWER |   z  |   x  |   c  |   v  |   b  |  |   n  |   m  |      |  Tab | Alt  |RAISE |
 * |-----------------------------------------|  |-----------------------------------------|
 * |       |KC_LGUI|BACKSP | Space |         |  |        | Enter | Delete|KC_RGUI|        |
 * |------------------------------------------  ------------------------------------------|

 */
  [_QWERTY] = LAYOUT( \
    KC_ESC,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV , \
    KC_LSFT,  KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    XXXXXXX, \
    KC_LCTRL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    XXXXXXX, XXXXXXX, \
    LOWER,    KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,   XXXXXXX,  XXXXXXX, KC_N,    KC_M,    XXXXXXX, KC_TAB,  KC_RALT, RAISE,   \
                               XXXXXXX, KC_LGUI, KC_BSPC,KC_SPC,   KC_ENT,  KC_DEL,  KC_RGUI, XXXXXXX \
  ),
 ...
 * |------+------+------+------+------+------|______ |    |______ |------+------+------+------+-------+------|
 * |______| Cut  | Copy |Paste |______|______|-------|    |-------|______|M_Btn1|M_Btn2|M_btn3|M_btn4 |______|
 * `-----------------------------------------/       /     \      \------------------------------------------'
 ...
 */
  ...
  [_RAISE] = LAYOUT( \
    ...
    _______, KC_CUT,  KC_COPY, KC_PASTE, _______,  _______,  _______, _______, _______, KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN4, _______, \
